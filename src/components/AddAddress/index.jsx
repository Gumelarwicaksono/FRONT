      ...
      <Row>
        <Col md={6}>
          <Form.Group className="mb-3" controlId="nama">
            ...
            <Form.Control type="text" placeholder="Masukan nama alamat" isInvalid={errors.nama} {...register('nama')} />
          ...
          <Form.Group className="mb-3" controlId="detail">
            ...
            <Form.Control type="text" placeholder="Masukan detail alamat" as="textarea" isInvalid={errors.nama} rows={9} {...register('detail')} />
        ...
        <Col md={6}>
          <Form.Group className="mb-3" controlId="provinsi">
            ...
            <CustomFormSelect onChange={(value) => updateValue('provinsi', JSON.parse(value))} isInvalid={errors.provinsi} value={getValues()?.provinsi?.value} location="provinsi" />
